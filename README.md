...
To run this project locally first download it. After download install necessary  dependencies by running npm install, or yarn ins
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0OTI3NTIyNDksODk0MTAxMjY0LC03Nj
MxMzEwOF19
-->